        ...
        <div className="px-4 lg:px-6 pt-4 lg:pt-6 pb-8">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-3 lg:gap-4 mb-5 lg:mb-6">
            {STATS.map(({ label, value, icon: Icon, color, bg }) => (
              <div
                key={label}
                className="bg-card rounded-2xl border border-border p-3.5 lg:p-4 flex flex-col gap-2.5 lg:gap-3"
              >
                ...
                {statsLoading || value === null ? (
                  ...
                  <p className="font-heading font-bold text-foreground text-base lg:text-2xl truncate">
                    {value}
                  </p>
                )}
              </div>
                ...
                return (
                  <div key={order.id} className="px-4 py-3 flex flex-col gap-1.5">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span
                        className={cn(
                          'text-[11px] font-medium px-2 py-0.5 rounded-full border whitespace-nowrap shrink-0',
